...
ex09_interface__srv__FullNameSumService_Request__init(ex09_interface__srv__FullNameSumService_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->last_name)) {
    ex09_interface__srv__FullNameSumService_Request__fini(msg);
    return false;
  }
  // name
...
ex09_interface__srv__FullNameSumService_Request__create()
{
  ...
  ex09_interface__srv__FullNameSumService_Request * msg = (ex09_interface__srv__FullNameSumService_Request *)allocator.allocate(sizeof(ex09_interface__srv__FullNameSumService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ex09_interface__srv__FullNameSumService_Request));
  bool success = ex09_interface__srv__FullNameSumService_Request__init(msg);
  if (!success) {
...
ex09_interface__srv__FullNameSumService_Request__Sequence__init(ex09_interface__srv__FullNameSumService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ex09_interface__srv__FullNameSumService_Request * data = NULL;

  if (size) {
    data = (ex09_interface__srv__FullNameSumService_Request *)allocator.zero_allocate(size, sizeof(ex09_interface__srv__FullNameSumService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ex09_interface__srv__FullNameSumService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ex09_interface__srv__FullNameSumService_Request__fini(&data[i - 1]);
      }
...
ex09_interface__srv__FullNameSumService_Request__Sequence__fini(ex09_interface__srv__FullNameSumService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ex09_interface__srv__FullNameSumService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ex09_interface__srv__FullNameSumService_Request__Sequence * array = (ex09_interface__srv__FullNameSumService_Request__Sequence *)allocator.allocate(sizeof(ex09_interface__srv__FullNameSumService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ex09_interface__srv__FullNameSumService_Request__Sequence__init(array, size);
  if (!success) {
...
ex09_interface__srv__FullNameSumService_Request__Sequence__destroy(ex09_interface__srv__FullNameSumService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ex09_interface__srv__FullNameSumService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ex09_interface__srv__FullNameSumService_Request__Sequence__are_equal(const ex09_interface__srv__FullNameSumService_Request__Sequence * lhs, const ex09_interface__srv__FullNameSumService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ex09_interface__srv__FullNameSumService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ex09_interface__srv__FullNameSumService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ex09_interface__srv__FullNameSumService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ex09_interface__srv__FullNameSumService_Request * data =
      (ex09_interface__srv__FullNameSumService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ex09_interface__srv__FullNameSumService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ex09_interface__srv__FullNameSumService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ex09_interface__srv__FullNameSumService_Request__copy(
...
ex09_interface__srv__FullNameSumService_Response__init(ex09_interface__srv__FullNameSumService_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->full_name)) {
    ex09_interface__srv__FullNameSumService_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ex09_interface__srv__FullNameSumService_Response * msg = (ex09_interface__srv__FullNameSumService_Response *)allocator.allocate(sizeof(ex09_interface__srv__FullNameSumService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ex09_interface__srv__FullNameSumService_Response));
  bool success = ex09_interface__srv__FullNameSumService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ex09_interface__srv__FullNameSumService_Response__Sequence__init(ex09_interface__srv__FullNameSumService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ex09_interface__srv__FullNameSumService_Response * data = NULL;

  if (size) {
    data = (ex09_interface__srv__FullNameSumService_Response *)allocator.zero_allocate(size, sizeof(ex09_interface__srv__FullNameSumService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ex09_interface__srv__FullNameSumService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ex09_interface__srv__FullNameSumService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ex09_interface__srv__FullNameSumService_Response__Sequence__fini(ex09_interface__srv__FullNameSumService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ex09_interface__srv__FullNameSumService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ex09_interface__srv__FullNameSumService_Response__Sequence * array = (ex09_interface__srv__FullNameSumService_Response__Sequence *)allocator.allocate(sizeof(ex09_interface__srv__FullNameSumService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ex09_interface__srv__FullNameSumService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ex09_interface__srv__FullNameSumService_Response__Sequence__destroy(ex09_interface__srv__FullNameSumService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ex09_interface__srv__FullNameSumService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ex09_interface__srv__FullNameSumService_Response__Sequence__are_equal(const ex09_interface__srv__FullNameSumService_Response__Sequence * lhs, const ex09_interface__srv__FullNameSumService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ex09_interface__srv__FullNameSumService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ex09_interface__srv__FullNameSumService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ex09_interface__srv__FullNameSumService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ex09_interface__srv__FullNameSumService_Response * data =
      (ex09_interface__srv__FullNameSumService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ex09_interface__srv__FullNameSumService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ex09_interface__srv__FullNameSumService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ex09_interface__srv__FullNameSumService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
