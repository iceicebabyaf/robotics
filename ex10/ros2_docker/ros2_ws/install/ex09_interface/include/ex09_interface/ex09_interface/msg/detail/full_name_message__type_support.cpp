...
{
  new (message_memory) ex09_interface::msg::FullNameMessage(_init);
}

void FullNameMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ex09_interface::msg::FullNameMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FullNameMessage_message_member_array[3] = {
  {
    ...
    offsetof(ex09_interface::msg::FullNameMessage, last_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ex09_interface::msg::FullNameMessage, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ex09_interface::msg::FullNameMessage, first_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FullNameMessage_message_members = {
  "ex09_interface::msg",  // message namespace
  "FullNameMessage",  // message name
  3,  // number of fields
  sizeof(ex09_interface::msg::FullNameMessage),
...
get_message_type_support_handle<ex09_interface::msg::FullNameMessage>()
{
  return &::ex09_interface::msg::rosidl_typesupport_introspection_cpp::FullNameMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ex09_interface, msg, FullNameMessage)() {
  return &::ex09_interface::msg::rosidl_typesupport_introspection_cpp::FullNameMessage_message_type_support_handle;
}
