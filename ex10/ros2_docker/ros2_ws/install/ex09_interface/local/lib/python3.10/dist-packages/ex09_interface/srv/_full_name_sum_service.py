...
class Metaclass_FullNameSumService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ex09_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FullNameSumService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ex09_interface.srv.FullNameSumService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ex09_interface.srv import _full_name_sum_service
...
class FullNameSumService(metaclass=Metaclass_FullNameSumService):
    from ex09_interface.srv._full_name_sum_service import FullNameSumService_Request as Request
    from ex09_interface.srv._full_name_sum_service import FullNameSumService_Response as Response
