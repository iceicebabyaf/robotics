...
bool ex09_interface__msg__full_name_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ex09_interface.msg._full_name_message.FullNameMessage", full_classname_dest, 53) == 0);
  }
  ex09_interface__msg__FullNameMessage * ros_message = _ros_message;
  {  // last_name
...
PyObject * ex09_interface__msg__full_name_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ex09_interface.msg._full_name_message");
