...
static const _FullNameMessage_type_support_symbol_names_t _FullNameMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex09_interface, msg, FullNameMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ex09_interface, msg, FullNameMessage)),
  }
};
...
{
  return &::ex09_interface::msg::rosidl_typesupport_cpp::FullNameMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ex09_interface, msg, FullNameMessage)() {
  return get_message_type_support_handle<ex09_interface::msg::FullNameMessage>();
}
