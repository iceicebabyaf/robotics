...
#include "ex09_interface/msg/detail/full_name_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ex09_interface::msg::FullNameMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ex09_interface::msg::FullNameMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ex09_interface::msg::FullNameMessage *>(
    untyped_ros_message);
...
{
  return &ex09_interface::msg::typesupport_fastrtps_cpp::_FullNameMessage__handle;
}
