...
#include "ex09_interface/srv/detail/full_name_sum_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ex09_interface::srv::FullNameSumService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ex09_interface::srv::FullNameSumService_Request & ros_message)
{
  // Member: last_name
  cdr >> ros_message.last_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ex09_interface::srv::FullNameSumService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ex09_interface::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ex09_interface::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ex09_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<ex09_interface::srv::FullNameSumService_Request>()
{
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex09_interface, srv, FullNameSumService_Request)() {
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ex09_interface
cdr_serialize(
  const ex09_interface::srv::FullNameSumService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: full_name
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ex09_interface::srv::FullNameSumService_Response & ros_message)
{
  // Member: full_name
  cdr >> ros_message.full_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ex09_interface::srv::FullNameSumService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ex09_interface::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ex09_interface::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex09_interface, srv, FullNameSumService_Response)() {
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
{
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex09_interface, srv, FullNameSumService)() {
  return &ex09_interface::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
